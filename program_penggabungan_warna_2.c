...
// function: function disini berguna untuk 

const char* gabungWarna(const char *warna1, const char *warna2) { //function: 
...
int main() {
    ...
    scanf("%s", warna1); //input
    toLowerStr(warna1);

    printf("Masukkan warna ke-2 : ");
    scanf("%s", warna2); //input
    toLowerStr(warna2);

    const char* hasil = gabungWarna(warna1, warna2); //memanggil function 
    printf("\nHasil penggabungan antara warna %s dan warna %s yaitu menjadi warna %s\n\n", warna1, warna2, hasil);

    printf("--------------------------------\n");

    printf("Masukkan warna ke-3 : ");
    scanf("%s", warna3); //input
    toLowerStr(warna3);
